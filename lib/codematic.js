...
module.exports = function(options) {
  ...
  this.runFilechange = function() {
    this._onFilechange.forEach(function(rule) {
      this._watcher.push(watch(rule.filename, {
        persistent: typeof rule.persistent == 'undefined' ? true: rule.persistent,
        recursive: typeof rule.recursive == 'undefined' ? false : rule.recursive,
        encoding: typeof rule.encoding == 'undefined' ? 'utf8' : rule.encoding,
        filter: typeof rule.filter == 'string' ? new RegExp(rule.filter) : null,
        delay: typeof rule.delay == 'undefined' ? 100 : rule.delay,
  ...
  this.runSchedule = function() {
    this._onSchedule.forEach(function(rule) {
      if (typeof rule.schedule == 'string') {
        this._schedules.push(schedule.scheduleJob(rule.schedule, function(execDate) {
